...
$prod = $user->query("select * from products_list where video !='' ORDER BY sku ASC");
...
<html>
    ...
    <body>
        ...
        <ul>
            ...
            <li><a class="active" href="fpv.php">FPV Copters</a></li>
        ...
        <iframe src="shop.php" height="1080" width="960"></iframe>
    </body>
</html>
